...
void world::delete_projectile(projectile* newProjectile) {
  ...
  i = std::find(game_projectiles.begin(), game_projectiles.end(),
                newProjectile);
...
// Bullet factory
void world::create_projectile(int newX,
                              int newY,
                              bool newOwner,
                              float newAngle,
                              float newSpeed,
                              ...
                              int newWidth,
                              int newHeight) {
  game_projectiles.push_back(new projectile(newX, newY, newOwner, newAngle,
                                            newSpeed, newRicochet, newWidth,
                                            newHeight));
}
